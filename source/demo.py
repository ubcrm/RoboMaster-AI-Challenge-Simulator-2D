...
if __name__ == '__main__':
    ...
    blue_0 = Actor(0, game_state.blue_state.robot_states[0])
    red_0 = Actor(1, game_state.red_state.robot_states[0])
    blue_1 = Actor(2, game_state.blue_state.robot_states[1])
    red_1 = Actor(3, game_state.red_state.robot_states[1])
